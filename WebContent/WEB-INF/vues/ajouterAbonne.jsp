...
<html>
	...
	<div class="container-fluid PageParDefaut">
		...
		<div>
			<h2 class="titreTableau margeHaut">AJOUT ABONNE</h2>
		</div>
		
		<form method="post" action="<c:url value="/validerAjouterAbonne"/>">
			<br><br>
			<div class="titreTableau libelle">
				<font size=5 COLOR="white" >Prenom</font><br>
			</div>
			<div class="centrer-div">
				<INPUT name="prenom" class="input centrageInput ombre"></INPUT>
			</div><br>
			<div class="titreTableau libelle">
				<font size=5 COLOR="white">Nom</font><br>
			</div>
			<div class="centrer-div">
				<INPUT name="nom" class="input centrageInput ombre"></INPUT>
			</div><br>
			<div class="titreTableau libelle">
				<font size=5 COLOR="white">Date de naissance</font><br>
			</div>
			<div class="centrer-div">
				<INPUT name="dateDeNaissance" class="input centrageInput ombre" value="JJ/MM/YYYY"></INPUT> <br/>
			</div>
			<br>
			
			<div class="centrer-div titreTableau"><br/>
				<input type="submit" class="btn btn-primary margeBas" name="validerAjouterAbonne" value="VALIDER" /><br>
			</div>
